...
function CbSurfaceBillboardExt(_surface, _x, _y, _z, _xScale, _zScale, _yAngle, _color, _alpha, _xOrigin = 0, _yOrigin = 0)
{
    ...
    if (_global.__doubleSided)
    {
        ...
        vertex_position_3d(_vertexBuffer, _ltX + _dX, _ltY + _dY, _ltZ); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, _normalX, _normalY, 0); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, 0, 0); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _lbX + _dX, _lbY + _dY, _lbZ); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, _normalX, _normalY, 0); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, 0, 1); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _rtX + _dX, _rtY + _dY, _rtZ); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, _normalX, _normalY, 0); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, 1, 0); __CB_WRITE_INDEX
        
        vertex_position_3d(_vertexBuffer, _rtX + _dX, _rtY + _dY, _rtZ); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, _normalX, _normalY, 0); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, 1, 0); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _lbX + _dX, _lbY + _dY, _lbZ); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, _normalX, _normalY, 0); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, 0, 1); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _rbX + _dX, _rbY + _dY, _rbZ); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, _normalX, _normalY, 0); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, 1, 1); __CB_WRITE_INDEX
    ...
    {
        vertex_position_3d(_vertexBuffer, _ltX, _ltY, _ltZ); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, _normalX, _normalY, 0); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, 0, 0); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _lbX, _lbY, _lbZ); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, _normalX, _normalY, 0); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, 0, 1); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _rtX, _rtY, _rtZ); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, _normalX, _normalY, 0); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, 1, 0); __CB_WRITE_INDEX
        
        vertex_position_3d(_vertexBuffer, _rtX, _rtY, _rtZ); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, _normalX, _normalY, 0); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, 1, 0); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _lbX, _lbY, _lbZ); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, _normalX, _normalY, 0); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, 0, 1); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _rbX, _rbY, _rbZ); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, _normalX, _normalY, 0); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, 1, 1); __CB_WRITE_INDEX
    }
