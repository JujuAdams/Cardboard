...
function CardboardSpriteTriangle()
{
    ...
    if (CARDBOARD_WRITE_NORMALS)
    {
        ...
        if (_global.__doubleSided)
        {
            ...
            vertex_position_3d(_vertexBuffer, _x1 + _dX, _y1 + _dX, _z1 + _dZ); vertex_normal(_vertexBuffer, _normalX, _normalY, _normalZ); vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, lerp(_u0, _u1, _u1prop), lerp(_v0, _v1, _v1prop));
            vertex_position_3d(_vertexBuffer, _x3 + _dX, _y3 + _dX, _z3 + _dZ); vertex_normal(_vertexBuffer, _normalX, _normalY, _normalZ); vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, lerp(_u0, _u1, _u3prop), lerp(_v0, _v1, _v3prop));
            vertex_position_3d(_vertexBuffer, _x2 + _dX, _y2 + _dX, _z2 + _dZ); vertex_normal(_vertexBuffer, _normalX, _normalY, _normalZ); vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, lerp(_u0, _u1, _u2prop), lerp(_v0, _v1, _v2prop));
