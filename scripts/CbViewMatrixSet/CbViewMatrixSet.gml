/// Sets GameMaker's active view matrix using Cb's own z-tilt view matrix
/// 
/// This function also allows use of CbSpriteBillboard*()
/// You should use CbViewMatrixReset() to reset the view matrix after calling this function
/// 
...
function CbViewMatrixSet(_fromX, _fromY, _fromZ, _toX, _toY, _toZ, _axonometrix = undefined, _upX = undefined, _upY = undefined, _upZ = undefined)
{
    __CB_GLOBAL
    
    CbBillboardYawSet(_fromX, _fromY, _toX, _toY);
    
    _global.__oldMatrixView = matrix_get(matrix_view);
    matrix_set(matrix_view, CbViewMatrixBuild(_fromX, _fromY, _fromZ, _toX, _toY, _toZ, _axonometrix, _upX, _upY, _upZ));
}