...
function CbSpriteFloorExt(_sprite, _image, _x, _y, _z, _xScale, _yScale, _zAngle, _color, _alpha)
{
    ...
    {
        vertex_position_3d(_vertexBuffer, _ltX, _ltY, _z + CB_DOUBLE_SIDED_SPACING); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, 0, 0,  1); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, _u0, _v0); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _lbX, _lbY, _z + CB_DOUBLE_SIDED_SPACING); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, 0, 0,  1); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, _u0, _v1); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _rtX, _rtY, _z + CB_DOUBLE_SIDED_SPACING); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, 0, 0,  1); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, _u1, _v0); __CB_WRITE_INDEX
        
        vertex_position_3d(_vertexBuffer, _rtX, _rtY, _z + CB_DOUBLE_SIDED_SPACING); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, 0, 0,  1); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, _u1, _v0); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _lbX, _lbY, _z + CB_DOUBLE_SIDED_SPACING); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, 0, 0,  1); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, _u0, _v1); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _rbX, _rbY, _z + CB_DOUBLE_SIDED_SPACING); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, 0, 0,  1); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, _u1, _v1); __CB_WRITE_INDEX
    ...
    {
        vertex_position_3d(_vertexBuffer, _ltX, _ltY, _z); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, 0, 0, 1); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, _u0, _v0); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _lbX, _lbY, _z); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, 0, 0, 1); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, _u0, _v1); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _rtX, _rtY, _z); if (CB_WRITE_NORMALS) { vertex_normal(_vertexBuffer, 0, 0, 1); } vertex_color(_vertexBuffer, _color, _alpha); vertex_texcoord(_vertexBuffer, _u1, _v0); __CB_WRITE_INDEX
