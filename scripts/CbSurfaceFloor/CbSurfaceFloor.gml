...
function CbSurfaceFloor(_surface, _x, _y, _z, _xOrigin = 0, _yOrigin = 0)
{
    ...
    if (CB_WRITE_NORMALS)
    {
        vertex_position_3d(_vertexBuffer, _l, _t, _z); vertex_normal(_vertexBuffer, 0, 0, 1); vertex_color(_vertexBuffer, c_white, 1.0); vertex_texcoord(_vertexBuffer, 0, 0); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _l, _b, _z); vertex_normal(_vertexBuffer, 0, 0, 1); vertex_color(_vertexBuffer, c_white, 1.0); vertex_texcoord(_vertexBuffer, 0, 1); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _r, _t, _z); vertex_normal(_vertexBuffer, 0, 0, 1); vertex_color(_vertexBuffer, c_white, 1.0); vertex_texcoord(_vertexBuffer, 1, 0); __CB_WRITE_INDEX
        
        vertex_position_3d(_vertexBuffer, _r, _t, _z); vertex_normal(_vertexBuffer, 0, 0, 1); vertex_color(_vertexBuffer, c_white, 1.0); vertex_texcoord(_vertexBuffer, 1, 0); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _l, _b, _z); vertex_normal(_vertexBuffer, 0, 0, 1); vertex_color(_vertexBuffer, c_white, 1.0); vertex_texcoord(_vertexBuffer, 0, 1); __CB_WRITE_INDEX
        vertex_position_3d(_vertexBuffer, _r, _b, _z); vertex_normal(_vertexBuffer, 0, 0, 1); vertex_color(_vertexBuffer, c_white, 1.0); vertex_texcoord(_vertexBuffer, 1, 1); __CB_WRITE_INDEX
    }
    else
    {
